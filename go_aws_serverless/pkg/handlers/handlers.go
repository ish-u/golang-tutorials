...
import (
	...
	"github.com/ish-u/go-serverless/pkg/user"
)

var ErrorMethodNotAllowe = "Method Not Allowed"

type ErrorBody struct {
	ErrorBody *string `json:"error,omitempty"`
}
...
func UnhandledMethod() (*events.APIGatewayProxyResponse, error) {
	return apiResponse(http.StatusMethodNotAllowed, ErrorMethodNotAllowe)
}
